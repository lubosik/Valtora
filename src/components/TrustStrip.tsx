            ...
            <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
              ...
              {getEnabledComplianceBadges().map((badge, index) => (
                <div
                  ...
                  className="group relative flex items-center gap-2 px-3 py-1.5 bg-emirati-gold/10 rounded-full border border-emirati-gold/30 hover:border-emirati-gold/50 transition-all"
